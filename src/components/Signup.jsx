...
function signupAction(prevFormState, formData) {
    ...
    if(!isNotEmpty(password) || !hasMinLength(password, 6)) {
        errors.push('Please enter a valid password with at least 6 characters');
    }
    ...
    if(!isNotEmpty(firstName) || !isNotEmpty(lastName)) {
        errors.push('Please enter a valid first name & last name');
    }
            ...
            <fieldset>
                ...
                <div className="control">
                    <input
                        ...
                        id="friend"
                        name="acquisition"
                        value="friend" defaultChecked={formState.enteredValues?.acquisitionChannel.includes('friend')}
                    />
